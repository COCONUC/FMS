...
import 'package:FMS/models/staff_register.dart';
import 'package:FMS/models/work_schedule_data.dart';
            ...
            child: Column(
              ...
              children: [
                const Padding(
                    ...
                    child: Text('Đăng ký lịch nghỉ theo tuần',
                        style: TextStyle(
  ...
  checkAndPostSchedule(List<StaffRegister> list, schedule, token, context) async {
    ...
    if(list.isEmpty){
      ...
      AwesomeDialog(
        ...
        animType: AnimType.SCALE,
        dialogType: DialogType.WARNING,
        title: 'Đăng ký tối đa xx slots/tháng',
        dismissOnTouchOutside: false,
        btnOkOnPress: () {
          list.clear();
        },
